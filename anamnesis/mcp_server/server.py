...
Shared infrastructure (FastMCP instance, service accessors, error handling,
prompts, helpers) lives in _shared.py. This module contains only _impl
functions and @mcp.tool registrations.
"""
...
from anamnesis.mcp_server._shared import (  # noqa: F401 — re-exported for test imports
