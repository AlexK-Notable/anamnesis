...
# =============================================================================
# Backward-compat aliases (keep old _impl names for tests)
# =============================================================================
...
def _get_pattern_recommendations_impl(
    ...
    """Backward-compat wrapper for tests."""
    return _pattern_recommendations_helper(
        problem_description=problem_description,
        current_file=relative_path,
        include_related_files=include_related_files,
    )
...
def _predict_coding_approach_impl(
    ...
    """Backward-compat wrapper for tests."""
    return _predict_approach_helper(
        problem_description=problem_description,
        include_file_routing=include_file_routing,
    )
...
def _get_project_blueprint_impl(
    ...
    """Backward-compat wrapper for tests."""
    return _analyze_project_impl(path=path, scope="project", include_feature_map=include_feature_map)
...
def _analyze_codebase_impl(
    ...
    """Backward-compat wrapper for tests (was in search.py)."""
    return _analyze_codebase_helper(path=path, include_file_content=include_file_content)
